...
const STATS = [
  { key:'projects' as const, label:'Projects', icon:'🏗️', href:'/admin/projects', color:'#C2A878' },
  { key:'skills' as const, label:'Skills', icon:'🛠️', href:'/admin/skills', color:'#818CF8' },
  { key:'experience' as const, label:'Experience', icon:'💼', href:'/admin/experience', color:'#34D399' },
  { key:'certifications' as const, label:'Certifications', icon:'🏅', href:'/admin/certifications', color:'#F472B6' },
]

const QUICK = [
  { label:'Edit Profile', href:'/admin/profile', icon:'✏️' },
  { label:'Add Project', href:'/admin/projects', icon:'➕' },
  { label:'Add Skill', href:'/admin/skills', icon:'🛠️' },
    ...
    <div>
      ...
      <div className="admin-page-header">
        <div style={{ display:'flex', alignItems:'flex-start', justifyContent:'space-between', gap:'1rem', flexWrap:'wrap' }}>
          ...
          <Link href="/" target="_blank" className="a-btn a-btn-outline-gold">
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'1.25rem', marginBottom:'1.25rem' }}>
        ...
        <div className="a-card">
          <div style={{ padding:'1.25rem 1.5rem', borderBottom:'1px solid var(--a-border)', display:'flex', justifyContent:'space-between', alignItems:'center' }}>
            ...
            <Link href="/admin/profile" className="a-btn a-btn-outline-gold a-btn-xs">Edit →</Link>
          </div>
        ...
        <div className="a-card">
          <div style={{ padding:'1.25rem 1.5rem', borderBottom:'1px solid var(--a-border)', display:'flex', justifyContent:'space-between', alignItems:'center' }}>
            ...
            <Link href="/admin/projects" className="a-btn a-btn-outline-gold a-btn-xs">Manage →</Link>
          </div>
          {loading ? (
            <div style={{ padding:'1rem 1.5rem', display:'flex', flexDirection:'column', gap:'0.75rem' }}>
            ...
            <div className="a-empty">
              ...
              <Link href="/admin/projects" className="a-btn a-btn-outline-gold a-btn-sm" style={{ marginTop:'0.75rem' }}>+ Add Project</Link>
            </div>
          )}
        </div>
      </div>
