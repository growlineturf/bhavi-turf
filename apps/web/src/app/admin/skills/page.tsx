...
async function persist(skills: Skill[]) {
  return fetch('/api/admin/portfolio/skills', {
...
export default function SkillsAdmin() {
  ...
  useEffect(() => {
    fetch('/api/admin/portfolio/skills').then(r=>r.json())
                ...
                <div>
                  ...
                  {editing.iconSlug && (
                    <div style={{ display:'flex', alignItems:'center', gap:'0.75rem', marginTop:'0.5rem', padding:'0.6rem 0.8rem', background:'rgba(255,255,255,0.02)', borderRadius:8, border:'1px solid var(--a-border)' }}>
                      <img src={`https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/${editing.iconSlug}/${editing.iconSlug}-original.svg`}
                        alt="" width={22} height={22} onError={e=>{(e.target as HTMLImageElement).style.display='none'}} />
